...
This JAR must contain all the dependencies (including TestProject SDK) and your action, but not your tests. \
...
```gradle
jar {
    // Collect and zip all classes from runtime configuration
